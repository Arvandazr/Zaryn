defmodule Zaryn.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :posts, Zaryn.Posts.Post
    has_many :likes, Zaryn.Likes.Like
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    ...
    |> unsafe_validate_unique(:username, Zaryn.Repo)
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Zaryn.Repo)
  ...
  """
  def valid_password?(%Zaryn.Accounts.User{hashed_password: hashed_password}, password)
